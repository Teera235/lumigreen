...
const SAVED_CO2_KG = SAVED_ENERGY_KWH * EF;
const SAVED_CO2_TON = SAVED_CO2_KG / 1000;
            ...
            <div className="flex-1 grid grid-cols-2 gap-4">
              ...
              <div className="bg-gray-900 rounded-2xl p-5 border border-gray-800">
                <div className="flex items-center gap-2 mb-4">
                  ...
                  <span className="text-gray-400">Illuminance</span>
                </div>
              ...
              <div className="bg-gray-900 rounded-2xl p-5 border border-gray-800">
                <div className="flex items-center gap-2 mb-4">
                  ...
                  <span className="text-gray-400">LED Power</span>
                </div>
